...
public class Silicium extends SlimefunRessource {
    public Silicium(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
