...
public class AluminiumIngot extends SlimefunRessource {
    public AluminiumIngot(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
