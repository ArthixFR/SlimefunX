...
public class MagnesiumIngot extends SlimefunRessource {
    public MagnesiumIngot(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
