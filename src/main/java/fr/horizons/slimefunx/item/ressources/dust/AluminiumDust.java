...
public class AluminiumDust extends SlimefunRessource {
    public AluminiumDust(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
