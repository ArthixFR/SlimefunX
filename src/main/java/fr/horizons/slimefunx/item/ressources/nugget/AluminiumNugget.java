...
public class AluminiumNugget extends SlimefunRessource {
    public AluminiumNugget(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
