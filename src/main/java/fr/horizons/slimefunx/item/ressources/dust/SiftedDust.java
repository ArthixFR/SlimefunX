...
public class SiftedDust extends SlimefunRessource {
    public SiftedDust(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
