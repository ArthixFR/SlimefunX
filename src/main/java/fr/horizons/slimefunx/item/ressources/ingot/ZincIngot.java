...
public class ZincIngot extends SlimefunRessource {
    public ZincIngot(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
