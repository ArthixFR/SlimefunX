...
public class SilverNugget extends SlimefunRessource {
    public SilverNugget(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
