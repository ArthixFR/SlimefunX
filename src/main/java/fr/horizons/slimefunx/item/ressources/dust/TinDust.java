...
public class TinDust extends SlimefunRessource {
    public TinDust(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
