...
public class MagnesiumDust extends SlimefunRessource {
    public MagnesiumDust(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
