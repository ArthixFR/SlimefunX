...
public class GoldDust extends SlimefunRessource {
    public GoldDust(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
