...
public class CopperIngot extends SlimefunRessource {
    public CopperIngot(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
