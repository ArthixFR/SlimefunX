...
public class DiamondDust extends SlimefunRessource {
    public DiamondDust(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
