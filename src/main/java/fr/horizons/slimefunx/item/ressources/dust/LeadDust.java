...
public class LeadDust extends SlimefunRessource {
    public LeadDust(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
