...
public class LapisDust extends SlimefunRessource {
    public LapisDust(String id, Category category, ItemStack item, int textureId, @Nullable String name, @Nullable List<String> lore) {
